...
originalquery_queriesreturnedlist_map_file = os.path.join(output_location, "originalquery_queriesreturnedlist_map.pkl")
...
for query_record in unpacker:
    itemcount += 1
    print "Currently processing record: " + str(itemcount)+" out of 87 Million"
    if (itemcount == 101):
        break
