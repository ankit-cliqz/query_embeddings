...
# Version 5: Single Threaded Version : Use this to process all 87 Million Queries. Takes around 2 days!
...
def main():
    ...
    corpus_tmp5 = corpus_tmp4[5759253:]
    corpus = corpus_tmp5[5324082:]
    ...
    count_line = 1
    for line_tmp in corpus:
        generateQueryAndQueryVectorMap(line_tmp)
        print "Done: "+str(count_line)+" Left: "+str(corpuscount-count_line)+" out of: "+str(corpuscount)
        count_line+=1
